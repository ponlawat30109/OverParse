...
namespace OverParse
{
    ...
    class CustomSettingsProvider : SettingsProvider
    {
        ...
        /// <summary>
        /// https://stackoverflow.com/questions/2265271/
        /// Loads the file into memory.
        /// </summary>
        public CustomSettingsProvider() => SettingsDictionary = new Dictionary<string, SettingStruct>();

        /// <summary>
        /// Override.
        /// </summary>
        public override void Initialize(string name, System.Collections.Specialized.NameValueCollection config) => base.Initialize(ApplicationName, config);
