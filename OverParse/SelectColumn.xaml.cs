...
namespace OverParse
{
    ...
    {
        public bool ResultName, Pct, Dmg, Dmgd, DPS, JA, Cri, Hit, Atk, Tab, Vrb;

        public SelectColumn(bool Name, bool Pct, bool Dmg, bool Dmgd, bool DPS, bool JA, bool Cri, bool Hit, bool Atk, bool Tab,bool Vrb)
        {
            InitializeComponent();
